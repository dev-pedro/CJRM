...
Nessa aula eu aprendi a declarar variáveis do tipo "const", configurar o index.html para executar o arquivo javascript, indexando ele no body do html, aprendi a usar o devtools do navegador e imprimir no console os valores das variáveis.
