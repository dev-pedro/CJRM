...
//console.log(`À ${dessert} é um doce à base de coco, tradicional na América Latina e em Angola.`)
...
Nestes exercícios pude colocar em prática alguns conhecimentos que adquiri nas aulas anteriores sobre array, e consolidar um pouco mais os conhecimentos das aulas anteriores.
