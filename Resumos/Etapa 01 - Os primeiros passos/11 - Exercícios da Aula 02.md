...
//console.log(summerMessageLowerCase)
...
const winterMessageUpperCase = winterMessage.toUpperCase()
//console.log(winterMessageUpperCase)
/*
...
const realBestMove = bestMovie.replace('"La la land"', '"Moonlight"')
//console.log(realBestMove)
/*
...
//console.log(newName)
const nameDev = 'Pedro Henrique'
console.log(`Rumo a fluência em javascript, ${nameDev}!\nEsse texto usa template string.`)
```

Nessa aula aprendi a manipular strings utilizando templates e também utilizando alguns métodos como 'slice', 'replace', 'incremento', 'decremento' e outros métodos.
